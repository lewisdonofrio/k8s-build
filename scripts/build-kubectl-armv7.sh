...
ARTIFACT_DIR="${BUILD_ROOT}/artifacts/kubectl"
...
echo "[5/7] Cross-compiling kubectl for ARMv7..."
export GOOS=linux GOARCH=arm GOARM=7 CGO_ENABLED=0
make WHAT=cmd/kubectl

echo "[6/7] Packaging artifact..."
OUTPUT_BIN="_output/bin/kubectl"
TARGET_BIN="${ARTIFACT_DIR}/kubectl-${K8S_VERSION}-armv7"

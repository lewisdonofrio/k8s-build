...
ARTIFACT_DIR="${BUILD_ROOT}/artifacts/kube-apiserver"
...
echo "[5/7] Cross-compiling kube-apiserver for ARMv7..."
...
OUTPUT_BIN="_output/bin/kube-apiserver"
TARGET_BIN="${ARTIFACT_DIR}/kube-apiserver-${K8S_VERSION}-armv7"

...
ARTIFACT_DIR="${BUILD_ROOT}/artifacts/kubeadm"
...
echo "[5/7] Cross-compiling kubeadm for ARMv7..."
export GOOS=linux GOARCH=arm GOARM=7 CGO_ENABLED=0
make WHAT=cmd/kubeadm

echo "[6/7] Packaging artifact..."
OUTPUT_BIN="_output/bin/kubeadm"
TARGET_BIN="${ARTIFACT_DIR}/kubeadm-${K8S_VERSION}-armv7"
